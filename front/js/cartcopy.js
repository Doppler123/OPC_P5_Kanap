...
function all_products_from_API() {
  ...
  fetch("http://localhost:3000/api/products")
    ...
    .then(function (requestResults) {
      ...
      console.log(JSON.stringify(getElementById(a557292fe5814ea2b15c6ef4bd73ed83)));
    }
    )
    .catch(function (err) {
...
function all_products_from_API() {
  ...
  fetch("http://localhost:3000/api/products")
    ...
    .then(function (requestResults) {
      ...
      console.log(sofas.indexOf('107fb5b75607497b96722bda5b504926'));
      ...
      function get_product_number(i) {
        for (let x = 0; x < 8; x++) sofas.forEach(product => {
